...
const Pinjam = props => {
    ...
    return (
        <Portal>
            ...
            <Text style={styles.textTitle}>Konfirmasi Peminjaman</Text>
            <View
                style = {{
            ...
            <Dialog.Content style={{flexDirection: 'row', paddingTop: 15}}>
                <View style={{width: '70%', paddingHorizontal: 0}}>
                    <View flexDirection="row" style={{marginBottom: 5, justifyContent: 'flex-start', width: '100%'}}>
                        <Text style={{marginBottom: 0,}}>Lama Peminjaman : </Text>
                    ...
                    {/* <View flexDirection="row" style={{marginBottom: 5, justifyContent: 'flex-start', width: '100%'}}>
                        ...
                        <Text style={{fontWeight: 'bold', color: '#329052'}}>{token}</Text>
                    </View>
                    <View flexDirection="row" style={{marginBottom: 5, justifyContent: 'flex-start', width: '100%'}}>
