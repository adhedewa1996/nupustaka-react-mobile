...
export class Penyewaan extends Component {
    constructor(props) {
        super(props);
            this.state = {
            sewa: [],
   ...
   componentDidMount(){
    onToken().then(res => {
        ...
        axios.get(`http://powerful-headland-43561.herokuapp.com/api/auth/get/transaction/sewa`, {
            headers: {
                ...
                <View style={styles.Container}>
                    ...
                    <View style={styles.Card}>
                        ...
                        <View>
                            ...
                            <Text style={styles.Content}> dipinjamkan dengan harga { item.books.qty_sewa } Token </Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(Penyewaan)
